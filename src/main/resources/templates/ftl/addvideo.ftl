...
<head>
    ...
    <script src="/js/admin/addvideo.js"></script>
</head>
...
<div class="main-section mdui-color-theme">
    <a class="yoann mdui-text-center mdui-img-fluid mdui-hidden-sm-down" style="position:absolute;left:45%;top:40%;">精品课程-视频</a>
    <div id="headline_img"></div>

</div>
<!--中间内容-->
<div class="mdui-container">
    <h2 class="doc-chapter-title doc-chapter-title-first mdui-text-color-theme">视频操作 </h2>
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">视频名称</label>
        <input id="input_video_name" class="mdui-textfield-input" type="text" maxlength="20"/>
    </div>


    <div class="mdui-textfield">
        <label class="mdui-textfield-label">文件描述</label>
        <input id="input_video_desc" class="mdui-textfield-input" type="text" maxlength="60"/>
    </div>

    <div>
        <label class="mdui-textfield-label">作者</label>
        <select id="input_video_author" class="mdui-select">
    ...
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">视频上传</label>
