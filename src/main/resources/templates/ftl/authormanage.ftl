...
<head>
    ...
    <script src="/js/admin/authormanage.js"></script>
</head>
    ...
    <ul class="mdui-list" mdui-collapse="{accordion: true}" style="max-width: 360px;">
        ...
        <li  class="mdui-collapse-item">
            ...
            <ul class="mdui-collapse-item-body mdui-list mdui-list-dense mdui-color-grey-50" style="">
                ...
                <li id="menu_addfile" class="mdui-list-item mdui-ripple">添加文章</li>
        ...
        <li class="mdui-collapse-item">
            ...
            <ul class="mdui-collapse-item-body mdui-list mdui-list-dense mdui-color-grey-50" style="">
                ...
                <li id="menu_addpost" class="mdui-list-item mdui-ripple">添加文章</li>
