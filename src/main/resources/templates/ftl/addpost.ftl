...
<head>
    ...
    <script src="/js/admin/addpost.js"></script>
</head>
...
<div class="main-section mdui-color-theme">
    ...
    <img class="mdui-img-fluid" src="/upload/images/headline.jpg" style="background: no-repeat fixed center/cover"/>

</div>
<!--中间内容-->
<div class="mdui-container">
    <h2 class="doc-chapter-title doc-chapter-title-first mdui-text-color-theme">文章编辑 </h2>

    <div class="mdui-textfield">
        <label class="mdui-textfield-label">文章标题</label>
        <input id="input_post_title" class="mdui-textfield-input" type="text" maxlength="60"/>
    </div>


    <label class="mdui-textfield-label">文章优先级</label>
        <label class="mdui-slider mdui-slider-discrete">
            <input id="input_post_priority" type="range" step="1" min="0" max="100" value="1"/>
        </label>
    ...
    <div>
        ...
        <select id="input_post_category" class="mdui-select">
