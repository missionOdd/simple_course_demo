...
<head>
    ...
    <script src="/js/admin/addfile.js"></script>
</head>
...
<div class="main-section mdui-color-theme">
    <a class="yoann mdui-text-center mdui-img-fluid mdui-hidden-sm-down" style="position:absolute;left:45%;top:40%;">精品课程-文件</a>
    <div id="headline_img"></div>

</div>
<!--中间内容-->
<div class="mdui-container">
    <h2 class="doc-chapter-title doc-chapter-title-first mdui-text-color-theme">添加文件 </h2>
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">文件名称</label>
        <input id="input_file_name" class="mdui-textfield-input" type="text" maxlength="20"/>
    </div>

    <div class="mdui-textfield">
        <label class="mdui-textfield-label">文件标题</label>
        <input id="input_file_title" class="mdui-textfield-input" type="text" maxlength="60"/>
    </div>



    <div class="mdui-textfield">
        <label class="mdui-textfield-label">文件描述</label>
        <input id="input_file_desc" class="mdui-textfield-input" type="text" maxlength="60"/>
    </div>
    ...
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">文件上传</label>
        <input id="file"  type="file"/>
    </div>
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">缩略图上传</label>
        <input id="file_img" type="file"/>
    </div>
    <br/>
    <div id="head_img"></div>
    <br/><br/><br/>
