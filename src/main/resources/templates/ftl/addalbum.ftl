...
<div class="mdui-container">
    ...
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">相册标题</label>
        <input id="input_photo_cate_title" class="mdui-textfield-input" type="text" maxlength="60"/>
    </div>
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">相册描述</label>
        <textarea id="input_photo_cate_text" class="mdui-textfield-input"></textarea>
    </div>

    <div class="mdui-textfield">
        <label class="mdui-textfield-label">相册封面上传</label>
