...
<head>
    ...
    <script src="/js/admin/addnotice.js"></script>
</head>
...
<div class="main-section mdui-color-theme">
    <a class="yoann mdui-text-center mdui-img-fluid mdui-hidden-sm-down" style="position:absolute;left:45%;top:40%;">精品课程-公告</a>
    <div id="headline_img"></div>

</div>
<!--中间内容-->
<div class="mdui-container">
    <h2 class="doc-chapter-title doc-chapter-title-first mdui-text-color-theme">公告编辑 </h2>

    <div class="mdui-textfield">
        <label class="mdui-textfield-label">公告标题</label>
        <input id="input_notice_title" class="mdui-textfield-input" type="text" maxlength="60"/>
    </div>


    <label class="mdui-textfield-label">公告优先级</label>
    <label class="mdui-slider mdui-slider-discrete">
        <input id="input_notice_priority" type="range" step="1" min="0" max="100" value="1"/>
    </label>


    <div>
        <label class="mdui-textfield-label">作者</label>
        <select id="input_notice_author" class="mdui-select">
    ...
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">文章缩略图上传</label>
    ...
    <div id="editor_text" class="text"  min-height> <!--可使用 min-height 实现编辑区域自动增加高度-->
        <p><b>写点</b>什么好呢...</p>
        <br/><br/><br/><br/><br/>
    </div>
    <br/>
