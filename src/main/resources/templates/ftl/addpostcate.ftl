...
<head>
    ...
    <script src="/js/admin/addpostcate.js"></script>
</head>
...
<div class="mdui-container">
    <h2 class="doc-chapter-title doc-chapter-title-first mdui-text-color-theme">文章分类操作 </h2>

    <div class="mdui-textfield">
        <label class="mdui-textfield-label">分类标题</label>
        <input id="input_post_cate_title" class="mdui-textfield-input" type="text" maxlength="60"/>
    </div>
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">分类描述</label>
        <textarea id="input_post_cate_text" class="mdui-textfield-input"></textarea>
    </div>
