...
<head>
    ...
    <script src="/js/admin/addauthor.js"></script>
</head>
...
<div class="mdui-container">
    <h2 class="doc-chapter-title doc-chapter-title-first mdui-text-color-theme">作者操作 </h2>

    <div class="mdui-textfield">
        <i class="mdui-icon material-icons">email</i>
        <label class="mdui-textfield-label">Email</label>
        <input id="input_email" class="mdui-textfield-input" type="email" placeholder="Email"/>
    </div>
    ...
    <div class="mdui-textfield">
        ...
        <input id="input_username" class="mdui-textfield-input" type="text"/>
    </div>
    ...
    <div class="mdui-textfield">
        ...
        <input id="input_password" class="mdui-textfield-input" type="text" />
    </div>
</div>


    <div class="mdui-textfield">
        <label class="mdui-textfield-label">头像上传</label>
        <i class="mdui-icon material-icons">camera_enhance</i>
        <input id="file" class="mdui-textfield-input" type="file"/>
    </div>
    <br/>
