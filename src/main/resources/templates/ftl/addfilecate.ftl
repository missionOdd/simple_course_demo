...
<head>
    ...
    <script src="/js/admin/addfilecate.js"></script>
</head>
...
<div class="mdui-container">
    <h2 class="doc-chapter-title doc-chapter-title-first mdui-text-color-theme">添加文件分类 </h2>
    <div class="mdui-textfield">
        <label class="mdui-textfield-label">文件分类名称</label>
        <input id="input_file_cate_name" class="mdui-textfield-input" type="text" maxlength="20"/>
    </div>

    <div class="mdui-textfield">
        <label class="mdui-textfield-label">文件分类描述</label>
        <input id="input_file_cate_desc" class="mdui-textfield-input" type="text" maxlength="60"/>
    </div>
