...
<div class="main-section mdui-color-theme">
    <a class="yoann mdui-text-center mdui-img-fluid mdui-hidden-sm-down" style="position:absolute;left:40%;top:40%;">精品课程-首页</a>
            ...
            <div id="thumb_card" class="mdui-panel-item-body mdui-row-xs-3 mdui-row-sm-4 mdui-row-md-5 mdui-row-lg-6 mdui-row-xl-7 mdui-grid-list">
                ...
                <div class="mdui-col-sm-4">
                    <div class="mdui-grid-tile">
                        <a href="javascript:;"><img src="//mdui-aliyun.cdn.w3cbus.com/docs/assets/docs/img/card.jpg"/></a>
