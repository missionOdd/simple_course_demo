...
<div class="mdui-drawer mdui-drawer-right" id="drawer">
    ...
    <div class="mdui-typo-title">相关文章</div>
    <div class="mdui-divider-dark"></div>
    <ul class="mdui-list" id="post_list">
...
<div class="main-section mdui-color-theme">
    <a class="yoann mdui-text-center mdui-img-fluid mdui-hidden-sm-down" style="position:absolute;left:40%;top:40%;">精品课程-文章</a>
    ...
    <div class="mdui-panel" mdui-panel>
        <div class="mdui-panel-item mdui-panel-item-open">
            <div class="mdui-panel-item-header">
                <div class="mdui-panel-item-summary">文章内容</div>
                <div class="mdui-chip">
                    <span class="mdui-chip-icon"><i class="mdui-icon material-icons">person</i></span>
                    <span class="mdui-chip-title post_author">匿名</span>
                </div>
                &nbsp; &nbsp; &nbsp; &nbsp;
                <div class="mdui-chip">

                    <span class="mdui-chip-icon"><i class="mdui-icon material-icons">local_offer</i></span>
                    <span id="post_category" class="mdui-chip-title">无分类</span>
                </div>
            </div>

            <div class="mdui-panel-item-body">
                <h1 id="post_title" class="doc-title mdui-text-color-theme" style=" text-align:center;">标题</h1>

                <div class="doc-intro-module">
                    <h5 class="post_author"  style=" text-align:center;">作者</h5>

                    <p style=" text-align:right;"><a id="post_createTime">创建时间</a></p>
                </div>
                <div id="post_content" class="mdui-typo">无内容</div>
    ...
    <#else>
        ...
        <div class="mdui-panel-item">
            <div class="mdui-panel-item-header">
                ...
                <a  href="/frontend/postlist"  class="mdui-btn mdui-col-xs-1">更多>></a>
            </div>
            <div id="post_card" class="mdui-panel-item-body ">


                            <div  id="new_post_list" class="mdui-panel" mdui-panel></div>
