...
<div class="mdui-drawer mdui-drawer-right" id="drawer">
    ...
    <div class="mdui-typo-title">相关视频</div>
    <div class="mdui-divider-dark"></div>
    <ul class="mdui-list" id="video_list">
...
<div class="main-section mdui-color-theme">
    <a class="yoann mdui-text-center mdui-img-fluid mdui-hidden-sm-down" style="position:absolute;left:40%;top:40%;">精品课程-视频</a>
    ...
    <div class="mdui-panel" mdui-panel>
        <div class="mdui-panel-item mdui-panel-item-open">
            <div class="mdui-panel-item-header">
                <div class="mdui-panel-item-summary">视频内容</div>
                <div class="mdui-chip">
                    <span class="mdui-chip-icon"><i class="mdui-icon material-icons">person</i></span>
                    <span class="mdui-chip-title video_author">Example</span>
                </div>
            </div>

            <div class="mdui-panel-item-body">
                <div class="doc-intro-module">
                    <p style=" text-align:right;"><a id="video_createTime">创建时间</a></p>
                </div>
                <h1 id="video_name" class="doc-title mdui-text-color-theme" >标题</h1>


                <video id="video_content"  class="mdui-video-fluid mdui-shadow-8" controls>
                    <source src="" type="video/mp4">
                </video>
                <h5 class="video_author"  style=" text-align:right;">作者</h5>
                <div id="video_desc" class="mdui-typo">无内容</div>
